...
![Pasted image 20260720122306](../assets/Pasted%20image%2020260720122306.png)
...
![Pasted image 20260720122721](../assets/Pasted%20image%2020260720122721.png)
...
![Pasted image 20260720122939](../assets/Pasted%20image%2020260720122939.png)

Step 3: we again do a split and stop here. The model still made some mistakes with 3 + pts.

![Pasted image 20260720123050](../assets/Pasted%20image%2020260720123050.png)
...
![Pasted image 20260720123214](../assets/Pasted%20image%2020260720123214.png)
...
![Pasted image 20260720124249](../assets/Pasted%20image%2020260720124249.png)

Initially we assign weights to each row = (1 / number of data rows)

![Pasted image 20260720124427](../assets/Pasted%20image%2020260720124427.png)
...
![Pasted image 20260720124630](../assets/Pasted%20image%2020260720124630.png)

How to find error? error = sum of weights of all the rows where model was wrong.

![Pasted image 20260720124734](../assets/Pasted%20image%2020260720124734.png)
...
![Pasted image 20260720124904](../assets/Pasted%20image%2020260720124904.png)

We also need to ensure the sum of weights = 1. For that we normalise by dividing each row with the sum of all weights.

![Pasted image 20260720125127](../assets/Pasted%20image%2020260720125127.png)
...
![Pasted image 20260720125343](../assets/Pasted%20image%2020260720125343.png)
